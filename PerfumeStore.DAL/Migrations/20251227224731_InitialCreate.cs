        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BarcodeImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ProductType = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BasePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    PricePerMg = table.Column<decimal>(type: "decimal(18,6)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumLevel = table.Column<decimal>(type: "decimal(18,3)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sales_Users_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockMovements_Users_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "CustomPerfumeDetails",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SaleItemId = table.Column<int>(type: "int", nullable: false),
                    LiquidProductId = table.Column<int>(type: "int", nullable: false),
                    QuantityInMg = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                    BottleProductId = table.Column<int>(type: "int", nullable: false),
                    HasAlcohol = table.Column<bool>(type: "bit", nullable: false),
                    AlcoholPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    LiquidPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BottlePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomPerfumeDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomPerfumeDetails_Products_BottleProductId",
                        column: x => x.BottleProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomPerfumeDetails_Products_LiquidProductId",
                        column: x => x.LiquidProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomPerfumeDetails_SaleItems_SaleItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomPerfumeDetails_BottleProductId",
                table: "CustomPerfumeDetails",
                column: "BottleProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomPerfumeDetails_LiquidProductId",
                table: "CustomPerfumeDetails",
                column: "LiquidProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomPerfumeDetails_SaleItemId",
                table: "CustomPerfumeDetails",
                column: "SaleItemId",
                unique: true);
